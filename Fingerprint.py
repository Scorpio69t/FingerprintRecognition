...
def get_all_imgs(path):
    ...
    show(fingerprint, mask, cv.merge((mask, fingerprint, fingerprint)),path='img/threshold',num=num)
    W = (23, 23)
    ...
    show(skeleton, cv.merge((fingerprint, fingerprint, skeleton)),path='img/thinning',num=num)
